...
VALUES
  ('Ayesha Khan', 21, 'ayesha.khan@example.com', 'Female', 'Computer Science', '12 Rose Street'),
  ('Bilal Ahmed', 22, 'bilal.ahmed@example.com', 'Male', 'Information Technology', '34 Lake Avenue'),
  ('Sana Malik', 20, 'sana.malik@example.com', 'Female', 'Computer Science', '56 River Road'),
  ('Omar Abbas', 23, 'omar.abbas@example.com', 'Male', 'Software Engineering', '78 Hill Lane'),
